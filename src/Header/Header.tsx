      ...
      <div className='container'>
        <div className='flex justify-end'>
          ...
          <Popover
            ...
            className='flex items-center py-1 hover:text-gray-300 cursor-pointer'
            renderPopover={
              <div className='bg-white relative shadow-md rounded-sm border border-gray-200 pr-28 shadow-md'>
                <div className='flex flex-col py-2 px-3'>
        ...
        <div className='grid grid-cols-12 gap-4 items-end'>
          <Link to='/' className='col-span-2 ml-2'>
            <svg viewBox='0 0 192 65' className='h-8 lg:h-11 fill-amber-50'>
              <g fillRule='evenodd'>
          ...
          <form className='col-span-9'>
            <div className='bg-white rounded-sm p-1 flex'>
              ...
              />
              <button className='rounded-sm py-2 px-6 flex-shrink-0 bg-orange-600 hover:opacity-90'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='none'
                  viewBox='0 0 24 24'
          ...
          <div className='cols-span-1 mb-2 justify-self-start'>
            <Popover
              renderPopover={
                <div className='bg-white relative shadow-md rounded-sm border border-gray-200 max-w-[400px] text-sm mr-15'>
                  <div className='p-2'>
                      ...
                      <div className='mt-4 flex'>
                        ...
                        <div className='flex-grow ml-2 overflow-hidden'>
                          <div className='truncate'>
                            {' '}
                            Kurapika – thành viên cuối cùng của tộc Kurta trong Hunter x Hunter
                          </div>
                        </div>
                    ...
                    <div className='flex mt-6 item-center justify-between'>
                      <div className='capitalize text-xs text-gray-600'>1 Thêm vào giỏ hàng</div>
                      <button className='capitalize bg-orange-500 hover:brightness-90 px-4 py-2 rounded-sm text-white'>
                        Xem giỏ hàng
                      </button>
                    </div>
                  </div>
