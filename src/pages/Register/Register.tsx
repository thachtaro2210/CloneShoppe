          ...
          <div className='lg:col-span-2 lg:col-start-4'>
            <form className='p-10 rouded bg-white shadow-sm'>
                ...
                <div className="mt-8">
                 ...
                 <div className="mt-2">
                    <input type="password" name="password" className='p-3 w-full outline-none border border-gray-300 focus:border-gray-500 rounded-sm focus:shadow-sm' placeholder='password' />
                    <div className="mt-1 text-red-600 min-h-[1rem] text-sm"></div>
                </div>
                <div className="mt-2">
                    <input type="password" name="password" className='p-3 w-full outline-none border border-gray-300 focus:border-gray-500 rounded-sm focus:shadow-sm' placeholder='Confirm Password' />
                    <div className="mt-1 text-red-600 min-h-[1rem] text-sm"></div>
                </div>
                <div className="mt-3">
